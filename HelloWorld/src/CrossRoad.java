...
//		PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("countcross.out")));
		Scanner scanner=new Scanner(new File("C:\\Users\\Ziduo\\eclipse-workspace\\Momentum\\countcross.in"));
		PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\Ziduo\\eclipse-workspace\\Momentum\\countcross.out")));

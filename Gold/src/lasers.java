...
public class lasers {
	public static void main(String[] args)throws IOException {
		...
		boolean[] vis1=new boolean[map1.size()];
		boolean[] vis2=new boolean[map2.size()];
		for(int i=1; i<N+2; i++) {
